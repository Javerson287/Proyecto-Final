...
INSERT informe(indice, text, li, li2, li3, li4, text3, text4, text5, text6) VALUES ('PUESTA EN MARCHA', 'Para la óptima instalación del sistema de información usted deberá cumplir con los siguientes requisitos para su óptimo funcionamiento:', '•   Conexión a internet  3G o 4G.','•    Sistema operativo Windows 7 o superior.', '•    Navegador Google Chrome, Firefox, Opera o Safari.', '•   Equipo de 4 GB de RAM y un Intel core 2 duo o un AMD Athlon.', 'Este sistema de información fue hecho con los lenguajes HTML5, CSS3, JavaScript, PHP 7.4.12 y como gestor de bases de datos MySQL en su versión MariaDB.', 'El correo electrónico para el soporte del sistema de información es: damh1006@gmail.com.', 'El personal idóneo para la instalación de este software debe tener conocimientos básicos de informática, para la digitación de datos en la web, no debe tener titulación de programas avanzados o de nivel técnico, solo deberá tener a la mano el manual de usuario para la instalación y la información a ingresar para la posterior instalación del sistema.', 'Se aclara que este sistema de información no genera gran impacto ambiental debido a que está optimizado para equipos de bajos recursos y tiene un bajo impacto en el consumo energético, pero este si se ve afectado por algunos problemas el más común son los diferentes cortes de energía, pero este se puede solucionar gracias a que el software será alojado en un servidor permitiendo ingresar desde cualquier dispositivo que tenga conexión a internet (incluso con datos móviles), así se podrá revisar y editar la información sin depender de un equipo de cómputo.' );

INSERT informe(indice, text, text2, text3, text4,text5) VALUES ('CONFIDENCIALIDAD, INTEGRIDAD Y DISPONIBILIDAD', 'SEGURIDAD: nuestro sistema de información cuenta con un sistema de seguridad de inicio de sesión con correo y contraseña, las cuales se guardaran en la base de datos y se encriptaran de tal manera que será complicado para un tercero acceder a la información desde fuera del apartado del administrador.', 'El sistema de información cuenta con un sistema de recuperación de contraseña para el administrador que le permitirá obtenerla  directamente.', 'Por otro lado, nuestro sistema de información no le pedirá al usuario pagos mediante la aplicación,en caso de extorción u otro delito derivado, que usuario/os probablemente hicieron o cometieron dicha falta.', 'Por último, cabe aclarar que nuestro software no le pedirá al usuario datos muy personales como lo son: Número de tarjeta de crédito, pagos a ciertos convenios, su contraseña de otras redes sociales, dirección de su lugar de estadía ni nada que tenga que ver con su ubicación o datos bancarios.');
